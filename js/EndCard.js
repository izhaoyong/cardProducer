...
function setTextColor(){
    ...
    $('#colorWrapper').css('top',  690 );
    $('#colorWrapper').css('display','block');
}

$('#Endwrapper').click( function(event){
